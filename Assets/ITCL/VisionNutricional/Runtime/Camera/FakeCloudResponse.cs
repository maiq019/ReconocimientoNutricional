...
namespace ITCL.VisionNutricional.Runtime.Camera
{
  ...
  public class FakeCloudResponse : WhateverBehaviour<FakeCloudResponse>
  {
    ...
    public CamTextureToCloudVision.AnnotateImageResponses SandwichResponse0()
    {
      CamTextureToCloudVision.AnnotateImageResponse response = new();
    ...
    public CamTextureToCloudVision.AnnotateImageResponses SandwichResponse()
    {
      CamTextureToCloudVision.AnnotateImageResponses responses = new ()
      {
        responses = new List<CamTextureToCloudVision.AnnotateImageResponse>()
        {
          new()
          {
            labelAnnotations = new List<CamTextureToCloudVision.EntityAnnotation>()
            {
              new()
              {
                mid = "/m/02wbm",
              ...
              new()
              {
                ...
                score = 0.62118834f,
                topicality = 0.62118834f
              }
            },
            localizedObjectAnnotations = new List<CamTextureToCloudVision.EntityAnnotation>
            {
              new()
              {
                mid = "/m/02wbm",
                name = "Food",
                score = 0.7548894f,
                boundingPoly = new CamTextureToCloudVision.BoundingPoly
                {
                  normalizedVertices = new List<CamTextureToCloudVision.Vertex>
                  {
                    new(x: 0.012739923f, y: 0.18533784f),
                    new(x: 0.9357411f, y: 0.18533784f),
                    new(x: 0.9357411f, y: 0.65032506f),
                    new(x: 0.012739923f, y: 0.65032506f)
                  }
                }
